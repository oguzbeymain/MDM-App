...
Portable zip (`MDM-1.0.46-win-x64.zip`) is on the same release if you prefer not to use Setup.
...
Kurulum istemezsen aynı sürümde taşınabilir zip de var: `MDM-1.0.46-win-x64.zip`.
