...
### Install
1. Grab **[MDM-Setup](https://github.com/oguzbeymain/MDM-App/releases/latest)** (`MDM-Setup-1.0.49.exe`).
...
Portable zip (`MDM-1.0.49-win-x64.zip`) is on the same release if you prefer not to use Setup.
...
### Kurulum
1. **[MDM-Setup](https://github.com/oguzbeymain/MDM-App/releases/latest)** dosyasını indir (`MDM-Setup-1.0.49.exe`).
...
Kurulum istemezsen aynı sürümde taşınabilir zip de var: `MDM-1.0.49-win-x64.zip`.
